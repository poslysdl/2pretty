...
<script src="<?php echo Yii::app()->theme->baseUrl; ?>/scripts/form-validation.js"></script> 
    <script type="text/javascript" src="<?php echo Yii::app()->theme->baseUrl; ?>/plugins/jquery-combify/jquery-ui.min.js"></script>
<script type="text/javascript" src="<?php echo Yii::app()->theme->baseUrl; ?>/plugins/jquery-combify/jquery.ui.combify.js"></script>
