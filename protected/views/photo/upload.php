    ...
    <div id="add-image-index" class="modal modal-scroll fade modal-add-image">
        ...
        <div class="row"> <div class="col-md-12"><div id="error-status"></div></div></div>
                ...
                <div class="row">
                  <div class="col-md-8">
                    <div class="usepic boxshadown">
                      <div class="main-img-user"> <img class="img-responsive  display-image" alt="" src="<?php 
                            ...
                            echo Yii::app()->baseUrl.'/profiles/'.$u->userDetails->user_details_avatar; ?>">
                        <div class="mask">
