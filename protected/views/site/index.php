                  ...
                  <div class="people">
                    ...
                    if(Yii::app()->user->isGuest)
                    {
						...
						if(isset($tusers))
						{
                            ...
                            <?php echo $u->userDetails->user_details_firstname.' '.$u->userDetails->user_details_lastname; ?>
                            
                            <?php  echo CHtml::link($u->userDetails->user_details_firstname.' '.$u->userDetails->user_details_lastname, array('profile/index', 'url'=>$u->userDetails->user_unique_url), array('class'=>'username'));  ?> </span></a>
					...
					else
					{
						...
						if(isset($tusers))
						{
						   ...
						   <?php 
						   	// Display with class "avan" bold 
						   	//echo $u->userDetails->user_details_firstname.' '.$u->userDetails->user_details_lastname; 
						   ?>
                            
						    	<?php  echo CHtml::link($u->userDetails->user_details_firstname.' '.$u->userDetails->user_details_lastname, array('profile/index', 'url'=>$u->userDetails->user_unique_url), array('class'=>'avan'));  ?>
  	...
  	foreach($photos as $p)
  	{
            ...
            <div class="portlet-title">
              <div class="caption"> <img src="<?php
                ...
                <div class="cap1"> 
                <?php echo CHtml::link($p->user->userDetails->user_details_firstname.' '.$p->user->userDetails->user_details_lastname, array('profile/index', 'url'=>$p->user->userDetails->user_unique_url), array('class'=>'username')); ?>
                <span class="user-locaion"><?php if(isset($p->user->userLocation->user_location_country) && isset($p->user->userLocation->user_location_city))
            ...
            <div class="portlet-body">
              ...
              <form>
                ...
                <div class="main-name"> <i class="icon-heart"></i> <a href="#"></a> <span lphid="<?php echo $firstId; ?>"><?php echo $likescount; ?> liked1 this</span> </div>
				...
				?>
                <div class="comment-form"> <img src="<?php
							$CommentAvatar=UsersDetails::model()->find("user_id=".Yii::app()->user->id);
							if(isset($CommentAvatar)) {
								 $fromurl=strstr($CommentAvatar['user_details_avatar'], '://', true);
            	                if($fromurl=='http' || $fromurl=='https')
                	            	echo $CommentAvatar->user_details_avatar; 
                    	        else
                        		    echo Yii::app()->baseUrl.'/profiles/'.$CommentAvatar['user_details_avatar'];
                       			
                       			//echo Yii::app()->baseUrl.'/profiles/'.$CommentAvatar['user_details_avatar'];
                       		}
                       		?>" alt="" class="avatar img-responsive">
          ...
          <div class="portlet box blue boxshadown">
            <div class="portlet-title">
              <div class="caption"> <img src="<?php
                            ...
                            echo Yii::app()->baseUrl.'/profiles/'.$p->user->userDetails->user_details_avatar; ?>" alt="" class="avatar-user-l img-responsive">
                <div class="cap1"> <?php echo CHtml::link($p->user->userDetails->user_details_firstname.' '.$p->user->userDetails->user_details_lastname, array('profile/index', 'url'=>$p->user->userDetails->user_unique_url), array('class'=>'username')); ?><span class="user-locaion"><?php if(isset($p->user->userLocation->user_location_country) && isset($p->user->userLocation->user_location_city))
                 echo $p->user->userLocation->user_location_country.', '.$p->user->userLocation->user_location_city;
                 elseif(isset($p->user->userLocation->user_location_country))
                 echo $p->user->userLocation->user_location_country; ?></span> </div>
              </div>
